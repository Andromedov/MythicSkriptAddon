...
import com.gmail.berndivader.mythicskript.conditions.*;
import com.gmail.berndivader.mythicskript.conditions.mythicitem.ItemStackisMythicItem;
import com.gmail.berndivader.mythicskript.effects.*;
...
import com.gmail.berndivader.mythicskript.effects.mobitems.*;
import com.gmail.berndivader.mythicskript.effects.mythicspawner.*;
import com.gmail.berndivader.mythicskript.events.BukkitEvents;
import com.gmail.berndivader.mythicskript.events.skript.*;
import com.gmail.berndivader.mythicskript.expressions.*;
import com.gmail.berndivader.mythicskript.expressions.drops.*;
import com.gmail.berndivader.mythicskript.expressions.event.*;
import com.gmail.berndivader.mythicskript.expressions.mythicitem.*;
import com.gmail.berndivader.mythicskript.expressions.mythicmob.*;
import com.gmail.berndivader.mythicskript.expressions.mythicspawner.*;
import com.gmail.berndivader.mythicskript.expressions.skillmetadata.*;
...
public class MythicSkriptModule implements AddonModule {
    ...
    private void registerExpressions(SyntaxRegistry registry) {
        ...
        // === SkillMetadata ===
        expr(registry, com.gmail.berndivader.mythicskript.expressions.skillmetadata.GetCaster.class,
                Entity.class,   "[get] caster [of] [skilldata] %skilldata%");
        expr(registry, com.gmail.berndivader.mythicskript.expressions.skillmetadata.GetCause.class,
        ...
        expr(registry, com.gmail.berndivader.mythicskript.expressions.skillmetadata.GetTrigger.class,
                Entity.class,   "[get] trigger [entity] [of] [skilldata] %skilldata%");

        // === DropMetadata ===
        expr(registry, com.gmail.berndivader.mythicskript.expressions.dropmetadata.GetDropper.class,
                Entity.class,   "[get] dropper [of] [dropdata] %dropdata%");
        expr(registry, com.gmail.berndivader.mythicskript.expressions.dropmetadata.GetCaster.class,
                Entity.class,   "[get] caster [of] [dropdata] %dropdata%");
        expr(registry, com.gmail.berndivader.mythicskript.expressions.dropmetadata.GetCause.class,
                Entity.class,   "[get] cause [of] [dropdata] %dropdata%");
        expr(registry, com.gmail.berndivader.mythicskript.expressions.dropmetadata.GetTrigger.class,
                Entity.class,   "[get] trigger [of] [dropdata] %dropdata%");
        expr(registry, com.gmail.berndivader.mythicskript.expressions.dropmetadata.GetAmount.class,
                Float.class,    "[get] amount [of] [dropdata] %dropdata%");
        expr(registry, com.gmail.berndivader.mythicskript.expressions.dropmetadata.GetGenerations.class,
