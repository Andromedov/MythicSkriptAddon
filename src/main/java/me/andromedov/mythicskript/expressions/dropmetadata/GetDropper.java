package me.andromedov.mythicskript.expressions.dropmetadata;
...
public class GetDropper extends SimpleExpression<Entity> {
	...
	protected Entity[] get(Event event) {
		...
		if(data.getDropper().isPresent()) {
			return new Entity[] {data.getDropper().get().getEntity().getBukkitEntity()};
		}
		return null;
	}
