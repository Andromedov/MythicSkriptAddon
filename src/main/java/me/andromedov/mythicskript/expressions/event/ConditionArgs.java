package me.andromedov.mythicskript.expressions.event;
...
public class ConditionArgs extends SimpleExpression<String> {
	...
	protected String[] get(Event e) {
		return new String[]{((MythicSkriptConditionEvent)e).getArgs()};
	}
}
